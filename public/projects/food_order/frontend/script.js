...
function loginUser(email, role) {
    ...
    if(role === "customer") window.location.href = "./customer/home_customer.html";
    else if(role === "restaurant") window.location.href = "./restaurant/home_restaurant.html";
    else if(role === "delivery") window.location.href = "./delivery/home_delivery.html";
}
